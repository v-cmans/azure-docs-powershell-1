...
### -DiagnosticLogLevel
Specifies the diagnostic log level to use to record events during the file or folder export. 
The default value is Error.

If you specify this parameter and the *Debug* parameter, the cmdlet ignores this parameter and uses debug logging instead. 
...
### -DiagnosticLogPath
Specifies the path for the diagnostic log to record events to during the file or folder export.
If you do not specify a path, this cmdlet uses the default value `%LOCALAPPDATA%\AdlDataTransfer`.
